...
<body>
	<div class="wrap">
		...
		<div class="container">
			...
			<form  class="form-horizontal" action="${pageContext.request.contextPath }/auth/user/join" method="post" name="signup" id="signup" onsubmit=" return formCheck();">
...
3.  사이트와 이용자 간에 발생한 서비스 이용에 관한 분쟁에 대하여는 대한민국 법을 적용하며, 본 분쟁으로 인한 소는 대한민국의 법원에 제기합니다.
				...
				<div class="form-group  text-left">
					      ...
					      <div class="form-group text-left"> <label class="control-label" for="um_username">아이디(이메일)</label> </div>
				  <div class="input-group mb-3 text-left">
				  <input class="form-control" type="email" id="um_username" name="um_username" maxlength="20" placeholder="아이디(이메일)를 입력해 주세요." required />
				  ...
				  <button class="btn btn-primary"  disabled="disabled" id="emailCK"  onclick="emailSend();" type="button">인증번호받기</button>
       			 ...
       			 <div class="form-group text-left"><label class="control-label" for="emailAC">아이디(이메일) 인증</label></div>
       			  <div class="input-group mb-3 text-left">
				...
				<div class="form-group text-left">
		            ...
		            <input class="form-control" type="password" id="um_password" name="um_password" maxlength="16" placeholder="비밀번호를 입력해 주세요." required />
		
		        </div>
				
				<div class="form-group text-left">
           			 <label class="control-label" for="pwck">비밀번호 재확인</label>
			         <input class="form-control" type="password" id="passwordCheck" name="passwordCheck" maxlength="16" placeholder="비밀번호를 재확인해 주세요." required />
			         <span class="error d-none" id="pwerror" style="color: red" > </span>
       			 </div>
       			 
				<div class="form-group text-left">
           			 <label class="control-label" for="rePwd">닉네임</label>
			         <input class="form-control" type="text" id="um_nickname" name="um_nickname" maxlength="20" placeholder="닉네임을 입력해 주세요." required />
       ...
       <input type="hidden" id="kind" name="kind" />
       			 ...
       			 <div class="text-center">
       			 	...
       			 	<button type="button" class="btn btn-primary form-control" value="회원가입" id="submit" disabled="disabled">회원가입</button>
		</div>
