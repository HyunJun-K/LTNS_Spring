...
public interface UserDAO extends DAO {
	...
	List<LikeDTO> findByPost_All(UserDTO user);
	List<LikeDTO> findByComment_All(UserDTO user);
	...
	List<LikeDTO> findByPost(@Param("user") UserDTO user, @Param("from")int from, @Param("to")int to);
	List<LikeDTO> findByComments(@Param("user") UserDTO user, @Param("from")int from, @Param("to")int to);
	...
	void findByLikePost(LikeDTO like);
